...
class InterneController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('dashboard/interne/index', compact('title','users'));
    }
    ...
    public function create()
    {
        ...
        $roles = Role::where('name', 'admin')
                        ->orWhere('name', 'interne')->get();
        return view('dashboard/interne/create', compact('title', 'roles'));
    }
    ...
    public function show(User $user)
    {
        ...
        return view('dashboard/interne/show', compact('title', 'users'));
    }
